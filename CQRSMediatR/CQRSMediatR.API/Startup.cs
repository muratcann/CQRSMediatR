using CQRSMediatR.Business;
using CQRSMediatR.Business.Handlers.CommandHandlers;
using CQRSMediatR.Business.Handlers.QueryHandlers;
using MediatR;
...
namespace CQRSMediatR.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CQRSMediatRExample v1");
